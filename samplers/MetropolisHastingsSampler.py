...
class MetropolisHastingsSampler(Sampler):
    ...
    def compute_sequence_energy(self, batch_tokens, method='raw', temp=1.0):
        ...
        selector_buffer = repeat(torch.arange(0, num_tokens).to(self.device), 'l -> b l', b=batch_size)
    ...
    def propose_new_sequence(self, batch_tokens, k=3, temp=1.0):
        ...
        logits[..., (len(self.alphabet.prepend_toks) + 20):] = -torch.finfo(logits.dtype).max
